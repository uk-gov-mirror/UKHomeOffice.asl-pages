const { differenceInDays, format: dateFormatter, isValid: isValidDate } = require('date-fns');
...
const formatDate = (date, format = dateFormat.medium) => isValidDate(date) ? dateFormatter(date, format) : '-';
