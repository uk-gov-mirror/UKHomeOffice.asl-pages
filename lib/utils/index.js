const { get, isEqual, mapValues, isPlainObject, omit, castArray } = require('lodash');
...
const queryStringFromState = ({
  ...
  page = page + 1;
  console.log(qs.stringify({ filters, sort, page }))
  return qs.stringify({ filters, sort, page });
}
