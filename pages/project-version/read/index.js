...
const { getPreviousVersion, getVersionChanges, getGrantedVersion, getVersionAmends } = require('../middleware');
...
module.exports = settings => {
  ...
  app.use(getPreviousVersion(), getVersionChanges(), getGrantedVersion(), getVersionAmends());
